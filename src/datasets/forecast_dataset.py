...
class TSDataset(Dataset):
    ...
    def get_channel_ids(self, timeseries_tensor: deeplake.Tensor, station: str):
        """
        ...
        return self._ts_channel_ids[station]
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        ts_channel_ids = self.get_channel_ids(ts_tensor, station)
        ...
        # print(f"ts:{x_timseries_data.shape}")
        if mean is not None:
        ...
        # if mean is not None:
        #     y_timseries_data = (y_timseries_data - mean) / std
